...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Avantti — Gestão da inovação" },
      {
        name: "description",
        content: "Protótipo de gestão de programas, objetivos estratégicos e desafios de inovação.",
      },
      { property: "og:title", content: "Avantti — Gestão da inovação" },
      {
